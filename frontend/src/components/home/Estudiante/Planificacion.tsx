...
export function Planificacion({ onBack }: PlanificacionProps) {
  return (
    <div className="max-w-4xl mx-auto py-6 space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-8 sm:p-12 shadow-xs flex flex-col items-center text-center">
        ...
        <p className="text-slate-600 max-w-lg text-sm sm:text-base leading-relaxed mb-6">
          Diseño y organización de unidades didácticas, planes de clases, objetivos de aprendizaje y recursos pedagógicos requeridos para tus sesiones de práctica docente.
        </p>
