...
export function HomeHeader({
  ...
  const rolDisplay = (user.roles && user.roles[0]) || user.rol || "COORDINADOR";
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200/80 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-20 shadow-xs">
      ...
      {/* Lado Derecho: Fecha en tiempo real + Identificación de Coordinador (Avatar interactivo) */}
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        {/* Identificación del Coordinador con Avatar */}
        <button
          type="button"
          ...
          title="Ver perfil de coordinador"
        >
