...
import { Eye, EyeOff, UserPlus, BookOpen, Loader2, Building2 } from "lucide-react";
...
export function CreateModal({
  ...
  const puedeTenerAsignatura =
    rol.toUpperCase().includes("ESTUDIANTE") ||
    rol.toUpperCase().includes("PROFESOR") ||
    rol.toUpperCase().includes("DOCENTE");
      ...
      <DialogContent className={`bg-white border border-slate-200 transition-all duration-300 ${isProfesorColaborador ? "sm:max-w-2xl lg:max-w-3xl" : "sm:max-w-lg"}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-1">
          ...
          <FieldGroup className="gap-3">
            ...
            {/* Asignatura y Lugar de Práctica según el rol */}
            {(puedeTenerAsignatura || isProfesorColaborador) && (
              <div
